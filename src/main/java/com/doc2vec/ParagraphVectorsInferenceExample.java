...
/**
 * This is example code for dl4j ParagraphVectors inference use implementation. In this example we load previously built
 * model, and pass raw sentences, probably never seen before, to get their vector representation.
 *
 *
 * ************************************************************************************************* PLEASE NOTE: THIS
 * EXAMPLE REQUIRES DL4J/ND4J VERSIONS >= 0.6.0 TO COMPILE SUCCESSFULLY
 * *************************************************************************************************
 *
...
public class ParagraphVectorsInferenceExample {
	...
	public static void main(String[] args) throws Exception {
		...
		vectors.getConfiguration().setIterations(1); // please note, we set iterations to 1 here, just to speedup
														// inference

		/*
		 * // here's alternative way of doing this, word2vec model can be used directly // PLEASE NOTE: you can't use
		 * Google-like model here, since it doesn't have any Huffman tree information shipped.
		 * 
		 * ParagraphVectors vectors = new ParagraphVectors.Builder() .useExistingWordVectors(word2vec) .build();
		 */
