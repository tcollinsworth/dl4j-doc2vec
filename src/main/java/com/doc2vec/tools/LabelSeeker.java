...
/**
 * This is primitive seeker for nearest labels. It's used instead of basic wordsNearest method because for
 * ParagraphVectors only labels should be taken into account, not individual words
 *
...
public class LabelSeeker {
	...
	/**
	 * This method accepts vector, that represents any document, and returns distances between this document, and
